...
7. TestInit()
	1. CGameObject* 형 변수 (g_Obj) 선언
		...
		3. Ptr<CMesh.> 형으로 변수 (RectMesh) 생성, RectMesh 에 CResourceMgr 의 FindRes<CMesh.>(L"RectMesh") 를 대입한다.
		4. g_Obj 의 m_arrRes[(UINT)RESOURCE_TYPE::MESHRENDER] 에 대해 SetMesh(RectMesh.GetResource()) 를 호출하여 Mesh 를 저장한다.
...
10. Script Library/ Script 폴더에 CPlayerScript class 생성
